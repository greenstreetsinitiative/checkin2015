...
from survey.forms import MakeLegs_NormalTW_Simple, MakeLegs_NormalFW_Simple, MakeLegs_WRTW_Simple, MakeLegs_WRFW_Simple
...
def simple_checkin(request):
    ...
    leg_formset_NormalTW = MakeLegs_NormalTW_Simple(instance=Commutersurvey(),
                                             prefix='ntw')
    leg_formset_NormalFW = MakeLegs_NormalFW_Simple(instance=Commutersurvey(),
                                             prefix='nfw')
    leg_formset_WRTW = MakeLegs_WRTW_Simple(instance=Commutersurvey(), prefix='wtw')
    leg_formset_WRFW = MakeLegs_WRFW_Simple(instance=Commutersurvey(), prefix='wfw')
    ...
    if request.method == 'POST':
        ...
        if commute_form.is_valid():
            ...
            leg_formset_WRTW = MakeLegs_WRTW_Simple(
                request.POST, instance=commutersurvey, prefix='wtw')

            leg_formset_WRFW = MakeLegs_WRFW_Simple(
                    request.POST, instance=commutersurvey, prefix='wfw')

            leg_formset_NormalTW = MakeLegs_NormalTW_Simple(
                    request.POST, instance=commutersurvey, prefix='ntw')

            leg_formset_NormalFW = MakeLegs_NormalFW_Simple(
    ...
    return render(request, "survey/simple_checkin.html",
                  {
                      'wr_day': wr_day,
                      'form': commute_form,
